...
export const Route = createFileRoute("/return-and-refunds")({
  head: () => ({
    meta: [
      { title: "Return & Refunds — FMANAR Luxury Italian Furniture" },
      {
        name: "description",
        content: "Return, exchange, and refund policies for FMANAR luxury Italian furniture.",
      },
    ],
  }),
  component: ReturnAndRefundsPage,
});
      ...
      <div className="block md:hidden bg-white text-black min-h-screen flex flex-col justify-between">
        ...
        <header className="sticky top-0 z-50 flex items-center justify-between bg-black px-5 py-3.5 text-white">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://wa.me/8618926150696?text=Hi%20FMANAR%2C%20I%20have%20an%20inquiry%20regarding%20returns%20and%20refunds."
              target="_blank"
        ...
        <main className="px-5 py-8 flex-1 space-y-8">
          ...
          <div className="space-y-8 text-xs leading-relaxed text-neutral-600">
            <section className="space-y-3">
              ...
              <p>
                If your order arrives damaged, is missing parts, or if you have received an incorrect item, please gather the following information and email our customer service team at{" "}
                <a href="mailto:fmnhome2015@gmail.com" className="text-neutral-900 font-medium underline">
                  fmnhome2015@gmail.com
                </a>:
              </p>
              <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-200 space-y-2">
                <p><strong className="text-neutral-900">1. Full Product Photo:</strong> Overall photo(s) of the complete item.</p>
                <p><strong className="text-neutral-900">2. Defect/Damage Close-ups:</strong> Clear photos of the affected areas from multiple angles.</p>
                <p><strong className="text-neutral-900">3. Packaging Photos:</strong> Photos of the original outer packaging and protective materials (if available).</p>
                <p><strong className="text-neutral-900">4. Order Details:</strong> Your Purchase Order (PO) number and a detailed description of the issue.</p>
              </div>
            ...
            <section className="space-y-2">
              ...
              <p>We want you to be completely delighted with your purchase.</p>
              <div className="space-y-2 pt-1">
                <p>
                  <strong className="text-neutral-900">Standard Products:</strong> Non-customized items may be returned within 14 days of receipt, provided they remain in their original condition and packaging.
                </p>
                <p>
                  <strong className="text-neutral-900">Custom & Bespoke Furniture:</strong> Due to their personalized nature, custom items are non-refundable. To guarantee your absolute satisfaction, we will provide thorough detailed inspections for your approval prior to dispatch, resolving any standard or issue before shipping.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                Every product undergoes rigorous quality control before dispatch. In the rare event that an item arrives damaged or defective, please notify our white-glove team within 48 hours of delivery so we can coordinate immediate repair or replacement.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                Once your returned item is received and inspected at our distribution warehouse, your refund will be processed to the original payment method within 5–7 business days.
              </p>
            </section>
          </div>
        </main>
        ...
        <footer className="bg-[#24272a] px-6 py-12 text-white">
          <div className="text-center space-y-6">
            ...
            <div className="pt-2 flex flex-col gap-3 text-xs uppercase tracking-[0.2em] text-neutral-300">
              ...
              <Link to="/return-and-refunds" className="text-[--gold] font-medium transition-colors">Return and Refunds</Link>
