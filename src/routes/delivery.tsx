      ...
      <div className="block md:hidden bg-white text-black min-h-screen flex flex-col justify-between">
        ...
        <header className="sticky top-0 z-50 flex items-center justify-between bg-black px-5 py-3.5 text-white">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://wa.me/8618926150696?text=Hi%20FMANAR%2C%20I%20have%20an%20inquiry%20regarding%20delivery%20and%20lead%20times."
              target="_blank"
          ...
          <div className="space-y-8 text-xs leading-relaxed text-neutral-600">
            ...
            <section className="space-y-2">
              ...
              <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-200 space-y-2">
                <p>
                  <strong className="text-neutral-900">In-Stock Items:</strong> Shipped within 2–5 business days following order confirmation.
                </p>
                <p>
                  <strong className="text-neutral-900">Custom Orders:</strong> Delivered in 45–50 business days, as every made-to-order piece is meticulously handcrafted in our workshop.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                <strong className="text-neutral-900">Client-Designated Carrier:</strong> Prior to shipment, we will verify the products with you via photos and video to ensure perfection, then secure them in custom wooden crates before handing them over to your specified freight provider.
              </p>
              <p>
                <strong className="text-neutral-900">Our Partnered Freight Service:</strong> Upon video confirmation, our trusted logistics partners will provide a comprehensive white-glove service. This includes delivering the items directly to your room of choice, complete unpacking, full assembly and inspection, and removal of all packaging materials.
              </p>
            </section>
        ...
        <footer className="bg-[#24272a] px-6 py-12 text-white">
          <div className="text-center space-y-6">
            ...
            <div className="pt-2 flex flex-col gap-3 text-xs uppercase tracking-[0.2em] text-neutral-300">
              ...
              <Link to="/delivery" className="text-[--gold] font-medium transition-colors">Delivery</Link>
