      ...
      <div className="block md:hidden bg-white text-black min-h-screen flex flex-col justify-between">
        ...
        <header className="sticky top-0 z-50 flex items-center justify-between bg-black px-5 py-3.5 text-white">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://wa.me/8618926150696?text=Hi%20FMANAR%2C%20I%20have%20an%20inquiry%20regarding%20shipping%20and%20logistics."
              target="_blank"
            ...
            <section className="space-y-3">
              ...
              <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-200 space-y-2.5">
                ...
                <ul className="space-y-1.5 text-neutral-600 list-disc pl-4">
                  <li><strong className="text-neutral-800">Optional Add-On:</strong> White-Glove Service is an optional, paid add-on service.</li>
                  <li><strong className="text-neutral-800">Potential Additional Fees:</strong> Supplemental charges may apply for remote regions, stair-carries, restricted elevator access, or oversized crates.</li>
                  <li><strong className="text-neutral-800">On-Site Presence:</strong> You or an authorized representative (18+) must be present during delivery.</li>
                  <li><strong className="text-neutral-800">Scope of Work:</strong> Includes placement, assembly (where applicable), and full packaging removal.</li>
                  <li><strong className="text-neutral-800">Safety & Refusal:</strong> We reserve the right to decline services if site conditions are unsafe.</li>
                </ul>
              </div>
            </section>
        ...
        <footer className="bg-[#24272a] px-6 py-12 text-white">
          <div className="text-center space-y-6">
            ...
            <div className="pt-2 flex flex-col gap-3 text-xs uppercase tracking-[0.2em] text-neutral-300">
              ...
              <Link to="/shipping-policy" className="text-[--gold] font-medium transition-colors">Shipping Policy</Link>
